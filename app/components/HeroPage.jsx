...
const HeroPage = () => {
  return (
    ...
    <div>
        <Navbar />
        <div className='relative   md:h-[400px] w-screen md:flex  md:justify-between '>
...
{/* <button className='ms-center block md:visible lg:visible bg-blue-500'>Find Provider</button> */}
            ...
            <img className='w-full md:h-[400px] md:w-[600px]'  src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcT58maSNwSE4QYhpzwPktJMHID5aS1ZitR1egEkjKMWSqKum9m_" alt="" />
        </div>
        </div>
  )
}
